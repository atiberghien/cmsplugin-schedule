...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LastEventsPlugin'
        db.create_table(u'cmsplugin_lasteventsplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('nb_event', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5)),
            ('event_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True)),
        ))
        db.send_create_signal(u'cmsplugin_schedule', ['LastEventsPlugin'])

        # Adding model 'EventsByPeriodPlugin'
        db.create_table(u'cmsplugin_eventsbyperiodplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('period', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'cmsplugin_schedule', ['EventsByPeriodPlugin'])


    def backwards(self, orm):
        # Deleting model 'LastEventsPlugin'
        db.delete_table(u'cmsplugin_lasteventsplugin')

        # Deleting model 'EventsByPeriodPlugin'
        db.delete_table(u'cmsplugin_eventsbyperiodplugin')
