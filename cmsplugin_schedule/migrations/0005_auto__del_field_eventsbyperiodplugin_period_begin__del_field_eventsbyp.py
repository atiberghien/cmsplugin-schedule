...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventsByPeriodPlugin.period'
        db.add_column(u'cmsplugin_eventsbyperiodplugin', 'period',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EventsByPeriodPlugin.period_begin'
        raise RuntimeError("Cannot reverse this migration. 'EventsByPeriodPlugin.period_begin' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EventsByPeriodPlugin.period_end'
        raise RuntimeError("Cannot reverse this migration. 'EventsByPeriodPlugin.period_end' and its values cannot be restored.")
    ...
    models = {
        ...
        u'cmsplugin_schedule.eventsbyperiodplugin': {
            ...
            'calendar': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['schedule.Calendar']"}),
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'period': ('django.db.models.fields.CharField', [], {'default': "'W'", 'max_length': '1'})
        },
