...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LastEventsPlugin.calendar'
        db.add_column(u'cmsplugin_lasteventsplugin', 'calendar',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['schedule.Calendar']),
                      keep_default=False)

        # Adding field 'EventsByPeriodPlugin.calendar'
        db.add_column(u'cmsplugin_eventsbyperiodplugin', 'calendar',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['schedule.Calendar']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LastEventsPlugin.calendar'
        db.delete_column(u'cmsplugin_lasteventsplugin', 'calendar_id')

        # Deleting field 'EventsByPeriodPlugin.calendar'
        db.delete_column(u'cmsplugin_eventsbyperiodplugin', 'calendar_id')
