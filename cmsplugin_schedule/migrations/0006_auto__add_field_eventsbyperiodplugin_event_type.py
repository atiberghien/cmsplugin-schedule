...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventsByPeriodPlugin.event_type'
        db.add_column(u'cmsplugin_eventsbyperiodplugin', 'event_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventsByPeriodPlugin.event_type'
        db.delete_column(u'cmsplugin_eventsbyperiodplugin', 'event_type_id')
