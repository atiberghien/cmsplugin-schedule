...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CalendarPlugin'
        db.create_table(u'cmsplugin_calendarplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('calendar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['schedule.Calendar'])),
        ))
        db.send_create_signal(u'cmsplugin_schedule', ['CalendarPlugin'])


    def backwards(self, orm):
        # Deleting model 'CalendarPlugin'
        db.delete_table(u'cmsplugin_calendarplugin')
